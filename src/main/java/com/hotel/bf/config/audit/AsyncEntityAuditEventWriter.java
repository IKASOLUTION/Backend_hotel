...
import com.hotel.bf.repository.EntityAuditEventRepository;
...
public class AsyncEntityAuditEventWriter {
    ...
    public void writeAuditEvent(Object target, EntityAuditAction action) {
        ...
        try {
            System.out.println("=============2==2=========="+target);
            EntityAuditEvent auditedEntity = prepareAuditEntity(target, action);
            System.out.println("=============2==3=========="+auditedEntity);
            if (auditedEntity != null) {
                System.out.println("=============2==3=4========="+auditedEntity);
             EntityAuditEvent auditEvent=   auditingEntityRepository.save(auditedEntity);
             System.out.println("=============2==3=4====5====="+auditEvent);
           //  System.out.println("=============2==3=4==7==5====="+auditingEntityRepository.findAll().size());
            }
        } catch (Exception e) {
    ...
    private EntityAuditEvent prepareAuditEntity(final Object entity, EntityAuditAction action) {
        ...
        final AbstractAuditEntity abstractAuditEntity = (AbstractAuditEntity) entity;
        if (EntityAuditAction.CREATE.equals(action)) {
            auditedEntity.setModifiedBy(abstractAuditEntity.getCreatedBy());
            auditedEntity.setModifiedDate(LocalDate.now());
